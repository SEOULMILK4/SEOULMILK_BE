...
public interface NtsTaxRepositoryCustom {
    ...
    Page<NtsTax> searchHometaxList(Member member, Pageable pageable, LocalDate startMonth, LocalDate endMonth, List<String> suName, List<String> ipName); // 세금 계산서 진위 여부 검증 후, 검색
