...
public interface NtsTaxRepositoryCustom {
    ...
    Page<NtsTax> searchHometaxList(Member member, Pageable pageable, Status status, LocalDate startDate, LocalDate endDate, List<String> suNameList, List<String> ipNameList); // 세금 계산서 진위 여부 검증 후, 검색
